...
int desktop_detach_client(struct desktop *d, struct client *c);
...
void desktop_fullscreen_client(struct desktop *d, struct client *c,
                               bool fullscreen);
bool desktop_locate_window(struct desktop *d, Window win, struct client **c);
...
int desktop_shift_client(struct desktop *d, struct client *c, int dir);
